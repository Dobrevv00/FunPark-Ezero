...
const run = async () => {
  ...
  /* --------------------------------------- Страница „Рожденни дни“ */
  await payload.updateGlobal({
    slug: "birthdays-page",
    data: {
      hero: {
        badge: "Рожденни дни",
        title: "Празнувайте при нас",
        titleAccent: "с готов пакет",
        text: "Изберете пакет според броя гости — храната, напитките и сесията на Въздушната Въжена градина са включени. Изпратете запитване и ще потвърдим датата.",
      },
      packages: {
        ctaLabel: "Запитване",
        capacityLabel: "до {children} деца · до {adults} възрастни",
        drinksTitle: "Напитки",
        aerialTitle: "Пакети с Уред Въздушна Въжена градина",
        hexagonTitle: "Пакети с Уред Хексагон",
      },
      form: {
        title: "Запитване за пакет",
        intro:
        ...
        emailPlaceholder: "your@email.com",
        messageLabel: "Съобщение",
        messagePlaceholder: "Дата, час, брой гости или друг въпрос…",
        submitLabel: "Изпрати запитване",
        successMessage:
      ...
      cta: {
        title: "Имате друга идея за празника?",
        text: "Пишете ни и ще съберем пакет според вашите гости, меню и часове.",
  ...
  /* Менютата са едни и същи за двата набора при еднакъв брой гости, затова
     са изнесени тук — така не могат да се разминат. */
  const menuTier10 = [
    {
      title: "Родители",
      items: lines([
        "10 бр. брускети с мус от авокадо и крема сирене,пушена сьомга и маслини.",
        "10 бр. брускети с мус от авокадо и крема сирене,пеперони и кисела краставичка.",
        "15 бр. Моцарелени Пръчици със сладко.",
        "15 бр. Зеленчукови Шишчета с чери домат,краставици,краве сирене и маслини.",
        "15 бр. по 30гр. Мини Домашни Свински Кюфтенца с Гриловани Зеленчуци.",
        "15 .бр. Хрупкави Пилешки крила/или 15 бр.Хрупкави Филенца",
        "3 бр. по 200 гр. порции Хрупкави Пържени Картофи",
      ]),
    },
    {
      title: "Деца",
      items: lines([
        "4 бр. по 100гр. Зеленчукови Свежи Пръчици/Моркови и Краставици.",
        "10 бр. по 30 гр. Мини Домашни Свински Кюфтенца с чери доматчета.",
        "2 бр  Пица Пеперони и Моцарела/ 8 малки парчета",
        "2 бр Пица Шунка и Моцарела/8 малки парчета",
        "10 бр Хрупкави Пилешки Филенца.",
        "3 бр. по 200 гр. порции Хрупкави Пържени Картофи",
      ]),
    },
  ];
  const drinksTier10 = lines(["Домашна Лимона - 3л.", "Минерална Вода – 2л."]);

  const menuTier15 = [
    {
      title: "Родители",
      items: lines([
        "15 бр. брускети с мус от авокадо и крема сирене,пушена сьомга и маслини.",
        "15 бр. брускети с мус от авокадо и крема сирене,пеперони и кисела краставичка.",
        "20 бр. Моцарелени Пръчици със сладко.",
        "20 бр. Зеленчукови Шишчета с чери домат,краставици,краве сирене и маслини.",
        "20 бр. по 30гр. Мини Домашни Свински Кюфтенца с Гриловани Зеленчуци.",
        "20 .бр. Хрупкави Пилешки крила/или 20 бр.Хрупкави Филенца",
        "4 бр. по 200 гр. порции Хрупкави Пържени Картофи",
      ]),
    },
    {
      title: "Деца",
      items: lines([
        "6 бр. по 100гр. Зеленчукови Свежи Пръчици/Моркови и Краставици.",
        "15 бр. по 30 гр. Мини Домашни Свински Кюфтенца с чери доматчета.",
        "3 бр  Пица Пеперони и Моцарела/ 12 малки парчета",
        "3 бр Пица Шунка и Моцарела/12 малки парчета",
        "15 бр Хрупкави Пилешки Филенца.",
        "4 бр. по 200 гр. порции Хрупкави Пържени Картофи",
      ]),
    },
  ];
  const drinksTier15 = lines(["Домашна Лимона - 5л.", "Минерална Вода – 3л."]);

  const menuTier20 = [
    {
      title: "Родители",
      items: lines([
        "20 бр. брускети с мус от авокадо и крема сирене,пушена сьомга и маслини.",
        "20 бр. брускети с мус от авокадо и крема сирене,пеперони и кисела краставичка.",
        "30 бр. Моцарелени Пръчици със сладко.",
        "30 бр. Зеленчукови Шишчета с чери домат,краставици,краве сирене и маслини.",
        "30 бр. по 30гр. Мини Домашни Свински Кюфтенца с Гриловани Зеленчуци.",
        "30 .бр. Хрупкави Пилешки крила/или 30 бр.Хрупкави Филенца",
        "6 бр. по 200 гр. порции Хрупкави Пържени Картофи",
      ]),
    },
    {
      title: "Деца",
      items: lines([
        "8 бр. по 100гр. Зеленчукови Свежи Пръчици/Моркови и Краставици.",
        "20 бр. по 30 гр. Мини Домашни Свински Кюфтенца с чери доматчета.",
        "4 бр  Пица Пеперони и Моцарела/ 16 малки парчета",
        "4 бр Пица Шунка и Моцарела/16 малки парчета",
        "20 бр Хрупкави Пилешки Филенца.",
        "6 бр. по 200 гр. порции Хрупкави Пържени Картофи",
      ]),
    },
  ];
